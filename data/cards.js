...
module.exports = [
  ...
  },
  {
    name: 'Ebola',
    description:
      'A virus that causes hemorrhagic fever, typically acquired by contact with an infected monkey, fruit bat, or person. Its most severe symptoms can include bleeding from the eyes, nose, ears, mouth, and rectum. There is no specific treatment for the disease.',
    category: 'ET CETERA',
    pointValue: 2
  },
  {
  ...
  },
  {
    ...
    description:
      "The deity of Pastafarianism. a parody religion opposing intelligent design. A contemporary version of Russell’s teapot, it is portrayed as a clump of pasta and meatballs with two eye stalks. It often appears touching Adam's finger in Michelangelo's Sistine Chapel ceiling painting.",
    category: 'FICTIONAL CHARACTER',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Sylvia Plath',
    description:
      'Poet, author, and wife of Ted Hughes, who was known for her confessional style of poetry as well as her novel The Bell Jar. She had a history of depression, leading to her suicide at 30 from carbon monoxide poisoning after sticking her head into an unlit oven.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    ...
    description:
      'A terrorist math professor, who sent explosive packages through the mail. When Penthouse offered to publish his manifesto. Industrial Society and Its Future. he asked to reserve the right to plant one more bomb, since the magazine was less "respectable" than others he solicited.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    name: 'Bill Cosby',
    description:
      'One of most famous comedians of all time. He created Fat Albert and played Cliff Huxtable on the show bearing his name. He is known for wearing sweaters, eating "Puddin’ Pops," and blaming much of the black incarceration rate on poor parenting.',
    category: 'CELEBRITY',
    pointValue: 1
  },
  {
    ...
    description:
      'A World War II icon, who represent- ed American women working factory jobs. She is most often associated with the "We Can Do It!” Westinghouse poster, depicting her flexing in a blue work shirt and red kerchief. Her Canadian precursor was Ronnie the Bren Gun Girl.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: "Hitler's Brain",
    description:
      "A trope first featured in a 60's sci-fi film, where Nazi scientists remove this organ from the Führer’s head and hide it in the fictional South American country of Mandoras. The film currently holds an approval rating of 0% on the metareview site Rotten Tomatoes.",
    category: 'ET CETERA',
    pointValue: 2
  },
  {
    name: 'Che Guevara',
    description:
      'A Marxist leader in the Cuban Revolution, whose rebellious image has been commodified on T-shirts worldwide. The image, a high contrast version of the Guerrillero Heroico photograph by Alberto Korda, depicts him with mustache, beret, and implacable expression.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    ...
    description:
      'Former KGB officer and current President of Russia. Under his rule, Russia has grown increasingly undemocratic. He cultivates a rugged image in state media, being shown riding haIf-dressed on horseback and "discovering" two Ancient Greek urns in the Black Sea.',
    category: 'CELEBRITY',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Julian Assange',
    description:
      'The Editor-in-chief of WikiLeaks and alleged sexual predator. Fearing extradition to Sweden for sexual assault and the US for espionage relating to the Chelsea Manning leaks he has been living in the Ecuadorian embassy in London since June 2012.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    ...
    description:
      'Sometimes known as “Blade Runner" or “the fastest man on no legs," this sprinter became the first double leg amputee to participate in the Olympics. He was subsequently charged with the murder of his girlfriend, but maintains that he confused her for an intruder.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    name: 'Elian Gonzalez',
    description:
      "A Cuban boy who was the subject of an international incident when his relatives attempted to keep him in the US against his father's wishes that he return to Cuba. A famous image from the event shows an armed border agent discovering the boy cowering in a closet.",
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
    ...
    description:
      'An actor and President of the NRA, who starred in such films as The Ten Commandments, The Omega Man, and Planet of the Apes, where he was known for lines such as "Take your stinking paws off me you damn dirty apes!" He became a vociferous gun advocate in the 80s.',
    category: 'CELEBRITY',
    pointValue: 1
  },
  {
    name: 'Leeroy Jenkins',
    description:
      'A World of Warcraft player famous for going afk while his guild planned a complicated raid, then proceeded to run into the encounter screaming his own name and getting his guildmates killed. After being called "stupid as hell," he cryptically replied "At least I have chicken.”',
    category: 'CELEBRITY',
    pointValue: 4
  },
  {
  ...
  },
  {
    name: 'Lou Gehrig',
    description:
      'A first baseman for the New York Yankees and member of baseball’s Hall of Fame. He was the first baseball player to have his uniform number retired. Late in his career, he developed amyotrophic lateral sclerosis (ALS), which is now synonymous with his name.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'Mr. Trololo',
    description:
      'The internet moniker of Eduard Khil, a Russian singer who became famous when his 1976 recording of "I Am Glad, \'Cause I’m Finally Returning Back Home" was uploaded to YouTube. Khil performs the song using nonsense syllable rather than the lyrics.',
    category: 'CELEBRITY',
    pointValue: 4
  },
  {
  ...
  },
  {
    ...
    description:
      'A terrorist known variously as the “principal architect of the 9/11 attacks" by the 9/11 Commission and "Ron Jeremy in a pillowcase" by Horatio Sanz. An engineer by training, he designed a vacuum cleaner while being held at a secret CIA detention facility in Poland.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'Hodor',
    description:
      'Winterfell’s stableboy in George RR. Martin’s A Song of Ice and Fire and the Game of Thrones TV adaptation.  He carries the crippled Bran Stark around in a large basket. Though his real name is Walder, he is only referred to by this name, since it is the only word he ever uses.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 3
  },
  {
    name: 'The 99%',
    description:
      'A category inspired by the political slogans of the Occupy Wall Street movement of 2011 that classify the majority of US citizens who are not members of the economic elite. According to the IRS, all individuals earning less than $343,927 fall into this group.',
    category: 'ET CETERA',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'Richord Pryor',
    description:
      'A comedian once described by Jerry Seinfeld as “the Picasso of our profession." who was famous for his open discussion of race. In a well—known incident, while freebasing cocaine, he poured 151-proof rum over his body, lit a match, and ran down the street on fire.',
    category: 'HISTORICAL FIGURE',
    pointValue: 1
  },
  {
    name: 'A Castrato',
    description:
      'A male vocal performer whose has an abnormally high vocal register, typically achieved by neutering the performer before puberty. There are today some "natural" performers with hormonal anomalies that give the same effect. The last castration for this occurred in the 1870s.',
    category: 'ET CETERA',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'A Beard',
    description:
      'A term referencing facial hair and used for a person who conceals someone else’s sexual orientation, either knowingly or unknowingly. This concept was an element in the 1984 film Broadway Danny Rose by Woody Allen and remains a popular comedic subject.',
    category: 'ET CETERA',
    pointValue: 1
  },
  {
    name: 'Anne Frank',
    description:
      'A wartime diarist and Holocaust victim. After visiting the famous site where her family hid from the Nazis for nearly two years. the pop star Justin Bieber wrote, "Truly inspiring to be able to come here. Anne was a great girl. Hopefully she would have been a belieber."',
    category: 'HISTORICAL FIGURE',
    pointValue: 1
  },
  {
  ...
  },
  {
    ...
    description:
      'The title creature of a 2009 horror film where a sadistic German doctor forms one of these by sewing three individuals together. mouth to anus, forcing them to share a single digestive system. The film‘s director explained that his work is partially a reflection on fascism.',
    category: 'ET CETERA',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Magic Mike',
    description:
      'The title character of a Steven Soderbergh film about a male stripper who performs at Xquisite Strip Club. Played by Channing Tatum, the character is loosely based on Tatum‘s real-life experience as a young stripper in Tampa, Florida.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 1
  },
  {
  ...
  },
  {
    ...
    description:
      'A would-be suicide bomber who tried and failed to blow up a plane with his casual footwear. He was caught trying to use a match to light a fuse mid-flight, explosive sneaker in his lap. The incident prompted the TSA to institute footwear screening at airports.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    ...
    description:
      'An actor who appeared in an Apple ad that was remixed on YouTube to make his speech sound slow and slurred (“What do you think th greatest gift of the holidays is? Internet?"). He has also appeared in The Fly, Jurassic Park, and many other films.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'Princess Di',
    description:
      'The ex-wife of Prince Charles and mother of William and Harry. She died tragically in a Paris car crash, which was found to be the result of grossly negligent driving and to the presence of paparazzi. Her funeral was one of the most viewed events in television history.',
    category: 'HISTORICAL FIGURE',
    pointValue: 1
  },
  {
  ...
  },
  {
    ...
    description:
      'The title infant from a 70s horror film by Roman Polanski. Its mother, played by Mia Farrow, fears that her husband made a Satanic pact with their neighbors in order for success in his acting career. At the conclusion, it is revealed that the child is actually the spawn of Satan.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'Your Mom',
    description:
      'The woman who gave birth to you and/or raised you. The word above or the actual name of your real—life caregiver are both valid.',
    category: 'ET CETERA',
    pointValue: 2
  },
  {
    name: 'Bubble Boy',
    description:
      'A person with a genetic disease that leaves them vulnerable to infection and forced to live in a completely sterile environment. One was famously portrayed on Seinfeld. where he fought with George over a Trivial Pursuit card that read “Moops” instead of “Moors."',
    category: 'FICTIONAL CHARACTER',
    pointValue: 3
  },
  {
    name: 'O.J. Simpson',
    description:
      'Former professional football player. actor. and lsotoner spokesman. He was found not guilty of murder in one of the most public trials of the 20th century. He wrote a book about the case called If I Did It and is currently incarcerated for the theft of his own sports memorabilia.',
    category: 'HISTORICAL FIGURE',
    pointValue: 1
  },
  {
  ...
  },
  {
    name: 'Jesus H. Christ',
    description:
      'A subversive Jewish rabbi, who Christians believe to be the Son of God and Messiah of the Old Testament. He allegedly performed miracles, was crucified by the Romans, and rose from the dead. A middle initial is used in various oaths, but its origin is unclear.',
    category: 'HISTORICAL FIGURE',
    pointValue: 1
  },
  {
...

  {
    ...
    description:
      'The moniker of Umar Farouk Abdulmutallab, a would-be terrorist who attempted to blow up a passenger plane with explosives sewn into his unmentionables. His plan failed when the explosives were soiled due to his wearing the same pants for two weeks straight.',
    category: 'CELEBRITY',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Paul Reubens',
    description:
      'An actor famous for his character Pee-wee Herman. He was arrested for masturbating in a Sarasota, FL adult theater in 1991. When confronted by police, he allegedly said "I\'m Pee-wee Herman" and suggested doing a local children’s benefit "to take care of this.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    name: 'Ceiling Cat',
    description:
      'The subject of a famous internet photo showing a feline peeking out of a hole and, allegedly, "watching you masturbate.” In 2010, a Redditor indicated that the hole was actually in a wall. claiming “This changes everything.“ The feline is said to have a rival in the basement.',
    category: 'CELEBRITY',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Oedipus',
    description:
      "A legendary Ancient Greek king who was prophesied to murder his father and marry his mother. The psychologist Sigmund Freud named his complex related to a person's unconscious desire to sexually possess their opposite sex parent after this person.",
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'Damien Hirst',
    description:
      'The wealthiest artist in the world, who is best known for selling a huge dead tiger shark preserved in formaldehyde for more than $8M. He once argued that the 9/11   terrorists “need congratulating" for "achieving something which nobody would have thought possible.',
    category: 'CELEBRITY',
    pointValue: 4
  },
  {
  ...
  },
  {
    name: 'Deep Throat',
    description:
      'The informant who leaked information about Richard Nixon’s involvement in the Watergate scandal. Decades later. former FBI Director Mark Felt revealed himself as the informant. A Washington Post editor chose the alias as a reference to pornographic film from the 70s.',
    category: 'HISTORICAL FIGURE',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Blackfish',
    description:
      'An orca at SeaWorId who raised questions about animal captivity by killing 3 people. In 2010, Motley Crue founder Tommy Lee wrote to SeaWorld’s president stating that he   knew humans still "get into the pool and masturbate him with a cow’s vagina filled with hot water.',
    category: 'CELEBRITY',
    pointValue: 4
  },
  {
  ...
  },
  {
    ...
    description:
      'A performer, civil rights activist. and the first black woman to star in a major film. She only performed for integrated audiences, though many of her acts, such as the exotic Danse Sauvage wearing a banana skirt, strike a contemporary viewer as still pretty messed up racially.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'A Virgin',
    description:
      'A person who has never engaged in sexual intercourse, either voluntarily or involuntarily. Once used only to refer to young women, it now describes any person who has not  participated in that activity and can even be used metaphorically. as in a nonalcoholic drink.',
    category: 'ET CETERA',
    pointValue: 1
  },
  {
    name: 'Andrea Yates',
    description:
      'The victim of severe postpartum depression who drowned her five children in a bathtub. While initially sentenced to life in prison. she was later found not guilty by reason of  insanity. Her case sparked an ongoing debate about mental health treatment in the US.',
    category: 'CELEBRITY',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Anthony Weiner',
    description:
      'The disgraced former Congressman, who sent explicit photographs of himself via Twitter. After one leaked, he was forced to resign. He was involved in a subsequent scandal after it was revealed that he continued sending photos under the alias Carlos Danger.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'A Swinger',
    description:
      'A person who engages in recreational intercourse outside of a monogamous relationship. Despite public declarations othenNise, in a recent study by the Kinsey Institute, these individuals make up 2-4% of married couples in North America—over 4 million people in total.',
    category: 'ET CETERA',
    pointValue: 1
  },
  {
  ...
  },
  {
    name: 'The Winklevii',
    description:
      'The twins, rowers, and entrepreneurs best known for suing Facebook founder Mark Zuckerberg for $140M, claiming he stole their idea for the social networking site. They are new venture capitalists, and as of 2014, own nearly 1% of all Bitcoin in existence.',
    category: 'CELEBRITY',
    pointValue: 3
  },
  {
  ...
  },
  {
    name: 'Rick James',
    description:
      'A musician whose decadent, drug-fueled lifestyle is frequently parodied, notably in several "True Hollywood Stories" on The Chappelle Show. The popularity of depictions of his cocaine habits and use of the word “bitch" contributed to Chappelle leaving the show.',
    category: 'CELEBRITY',
    pointValue: 1
  },
  {
  ...
  },
  {
    name: 'Thomas Kinkade',
    description:
      'The self—styled Painter of Light”, whose paintings often featured  cottages with glowing lights in overly saturated pastoral landscapes. He died, according to his mistress, "very happy" from acute intoxication of alcohol and   Valium.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: 'The Id',
    description:
      "One of the the three parts of Sigmund Freud's model of the psyche that constitute mental life. This part contains a person's instincts and is the source of our impulse for sex and aggression. In adult life it becomes the most dark, inaccessible aspect of personality.",
    category: 'ET CETERA',
    pointValue: 2
  },
  {
  ...
  },
  {
    ...
    description:
      'A ministerial order of the first Christian church to whom God grants the power of transubstantiation during Mass. Although they take a vow of chastity. there have been many molestation scandals, perhaps due to the ready access their authority affords them.',
    category: 'ET CETERA',
    pointValue: 2
  },
  {
    name: 'Jim Jones',
    description:
      'An American cult leader and founder of the Peoples Temple. After the group’s murder of a congressional delegation, he forced the mass suicide of its 910 members in their Guyana compound by drinking grape Kool—Aid laced with cyanide and sedatives.',
    category: 'HISTORICAL FIGURE',
    pointValue: 4
  },
  {
  ...
  },
  {
    ...
    description:
      'A wealthy German industrialist. who protected his Jewish factory employees from deportation and death during the Holocaust. By the end of World War II. he had spent his entire fortune on bribes to Nazi officials and black-market items for the workers on his famous list.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
    ...
    description:
      'The "Empress and Autocrat of all the Russias,” who led the country\'s Golden Age: an era of revitalization and recognition as a great power of Europe. She took many lovers during her reign, leading to legends about her sexual proclivities, including an erotic desire for horses.',
    category: 'HISTORICAL FIGURE',
    pointValue: 3
  },
  {
    name: 'Bobby Fischer',
    description:
      "America's greatest chess player and one of its most famous racists. He defeated Boris Spassky in 1971 to become world champion. A recluse, he returned to the public eye in the 90s to invent a new Chess timing system and to be a public anti-Semite before dying in Iceland in 2008.",
    category: 'HISTORICAL FIGURE',
    pointValue: 3
  },
  {
  ...
  },
  {
    ...
    description:
      'The alleged equine lover of a Russian Empress who led the country through its Golden Age. She took many lovers during her reign, which gave rise to legends about her sexual proclivities, including an erotic desire for this kind of animal.',
    category: 'HISTORICAL FIGURE',
    pointValue: 4
  },
  {
    name: 'Rob Ford',
    description:
      'The disgraced mayor of Toronto who confessed to smoking crack “probably in one of my drunken stupors.” Responding to allegations of sexual harassment, he said. "It was said I want to eat her pussy. I would never do that. I’ve got more than enough to eat at home."',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
  ...
  
  {
    ...
    description:
      'The title character of a 90s TV show
      about a 19th century aristocrat who
      sets up a clinic in Colorado Springs.
      Played by Jane Seymour, she
      introduces modern healing
      practices to the town‘s locals as well
      as to her rugged mountain man
      Byron Sully.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Skeletor",
    description:
      'The main villain in the Masters of
      the Universe fantasy world. He is the
      arch nemesis of He-Man and is
      typically shows with a blue
      humanoid body. bare skull. and
      purple hood. His goal is to learn the
      secrets of Castle Grayskull and use
      them to conquer the land of Eternia.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Montezuma",
    description:
      'The 9th tlatoani of Tenochtitlan and
      ruler of the Aztec Triple Alliance.
      During their first contact with
      Europeans, he was killed by
      conquistador Hernan Cortés’s men
      as the fled his capital. His “revenge"
      is a euphemism for contracting
      traveler's diarrhea in Mexico.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
    name: "Captain Ahab",
    description:
      'The monomaniacal. peg-Iegged
      commander of the Pequod
      whaleship in Herman Melville's novel
      Moby Dick. His quest for vengeance
      against the white whale drives him
      mad, leading to the death of his
      entire crew except Ishmael, the
      novel‘s narrator.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Star Wars Kid",
    description:
      'The star of a viral video that shows
      a high school student imitating
      Iightsaber moves using a golf ball
      retriever. The tape leaked online
      after being left in the basement of
      his school, leading to dozens of
      remixes featuring music and
  ...
  },
  {
    ...
    description:
      'A sexist archetype in literature, film,
      and games of a helpless woman
      that must be saved by a male
      character. such as Princess Peach in
      the Mario franchise. A recent
      YouTube series by Feminist
      Frequency charted the plot device
  ...
  },
  {
    ...
    description:
      'The co-anchor of CBS This Morning
      and Editor-at-Iarge for 0 Magazine.
      She gained notoriety for her
      Iong-running relationship with a
      famous talk show host and "Queen
      of All Media." Despite being married
      to a man, there are persistent
      rumors that the two are lovers.',
    category: 'CELEBRITY',
    pointValue: 4
  },
  {
    name: "A Merman",
    description:
      'The male version of the mythologi-
      cal creature that is a woman from
      the waist up but has a fish tail in
      place of legs. Their behaviors and
      abilities range across cultures, and
      include having green teeth, the
      ability to cure illnesses, seducing
      women, and holding tridents.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Clippy",
    description:
      'The nickname of the Office
      Assistant in Microsoft Office, who
      appears as the metal object used to
      hold sheets of paper together. He
      would “tap" on the monitor to get
      your attention. Supposedly,
      Microsoft's internal name for it was
      TFC (The Fucking Clown).',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "The 1%",
    description:
      'A political and economic classifica-
  ...
  },
  {
    name: "The Walrus",
    description:
      'The character in a song by the
      Beatles from their album Magical
      Mystery Tour. It is a reference to a
      Lewis Carroll’s poem, also about a
      flippered marine mammal. The lyrics
      that follow, "Goo Goo Ga Joob,“
      possibly stated by the character,
      were drawn from Finnegan’s Wake.
      ',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  ...
  },
  {
    name: "Helen Keller",
    description:
      'The deafblind author, leftist, and
  ...
  },
  {
    name: "Robocop",
    description:
      'The title character of an 805 sci-fi
      ...
      site Kickstarter to create a 7 foot tall
      bronze statue of the character.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Tubgirl",
    description:
      'A shock image depicting a naked,
      ...
      alleged to be popular in Japan.',
    category: 'CELEBRITY',
    pointValue: 4
  },
  {
  ...
  },
  {
    name: "Betsy Ross",
    description:
      'The person widely believed to have
      ...
      doubt on the veracity of this claim.',
    category: 'HISTORICAL FIGURE',
    pointValue: 2
  },
  {
  ...
  },
  {
    name: "Frogger",
    description:
      'The title amphibian from a classic
      80s arcade game. where you cross
      heavy traffic and hitch a ride on
      logs to cross a treacherous river. A
      real-life version was played with a
      Roomba decorated as the character.
      It made it across a highway 10 times
      before being flattened by an SUV.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Dr. Mario",
    description:
      'This plumber-turned-pharmacist
      and title character of this Nintendo
      puzzle series. Clearly inspired by
      Tetris, the player organizes pills by
      color. ostensibly to eradicate viruses
      and definitely not to teach children
      how to raid their parent’s medicine
      cabinet.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "An Amish",
    description:
      'A member of a Christian sect from
      PA Dutch country. They are known
      for wearing traditional dress and
      eschewing modern technology.
      Some practice Rumspringa, where
      restrictions are lifted for adoles-
      cents seeking to experience the
  ...
  },
  {
    ...
    description:
      'A rare occurrence where identical
      fetuses are joined together in utero.
      Classifications are based on where
      their bodies are joined, e.g.
      syncephalus (one head, single face.
      four ears, two bodies). cephalotho-
      racopagus (fused bodies, two faces
  ...
  },
  {
    name: "A Troll Doll",
    description:
      'A plastic toy depicting a being with
      distinctive tall, bright, and fuzzy
      hair. They were the subject of fads
      throughout the 705, 805, and 905.
      The original version was carved by a
      poor Danish fisherman and
      woodcutter as a Christmas gift to
      his daughter.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    ...
    description:
      'A 7'2" Congolese-American
      basketball player best known for his
      incredibly deep voice, thick accent.
      and penchant for waving his index
      finger at opponents after stuffing
      them at the rim. He once described
      the restaurant Pasta Pasta as being
      "named after pasta.”',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    name: "Comic Book Guy",
    description:
      'The overweight owner of The
      Android's Dungeon & Baseball Card
      Shop on The Simpsons. His
      character has a master's degree in
      folklore mythology—he translated
      The Lord of the Rings into
      Klingon—and is known for his
      catchphrase "Worst [blank] ever."',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "A Dead Horse",
    description:
      'Useless to beat and effectively
      unrideable. this deceased animal is
      used in an idiom to explain that a
      point, once made. does not need to
      be re-stated. Similar the phrase, "To
      slay the slain." This animal is
      substituted with a dog in other
  ...
  },
  {
    ...
    description:
      'A piece of raw beef worn by
      "Mother Monster” to the 2010 MTV
      Video Music Awards. The pop diva
      stated that she wore the item to
      highlight her distaste for the
      military’s don’t-ask-don’t-tell policy.
      The item was preserved by a
      taxidermist, who turned it into jerky.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    name: "Kenny G",
    description:
      'A smooth jazz saxophonist, who is
      universally reviled by jazz aficiona-
      dos while simultaneously being one
      of the best selling recording artists
      of all time. Using circular breathing,
      he set a world record for longest
      note recorded by holding an E-ﬂat
      for 45 minutes and 47 seconds.',
    category: 'CELEBRITY',
    pointValue: 1
  },
  {
    ...
    description:
      'The title of both Ralph Ellison‘s
      novel about the struggle of black
      intellectuals in early 20th century
      America and HG. Well’s sci—fi
      novella about a avaricious.
      power-mad man who is able to alter
      his body’s refractive index to reflect
      no light.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Hal-9OOO",
    description:
      'The sentient computer from Stanley
      Kubrick's 2001: A Space Odyssey.
      Initially a helpful part of the ship, it
      eventually turns on the crew, killing
      Dr. Poole before being disconnected
      by Dave. As its mind goes, it sings
      "Daisy Bell” while pleading for its
      life.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    ...
    description:
      'A singer, temporary member of
      Destiny's Child. and sister of
      Beyoncé. In 2014, TMZ published
      security footage of her physically
      assaulting her brother-in-law. Jay-Z,
      who along with Beyoncé, did not
      retaliate. The cause of her outburst
      remains unknown.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    name: "Carrie",
    description:
      'The title character of a horror film
      based on a Stephen King story. She
      manifests telekinetic abilities after
      being bullied about her first period.
      In the film’s climax, she is doused in
      an upended bucket of pig‘s blood at
      prom, leading her to kill most of the
      attendees in an electrical fire.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    ...
    description:
      'One half of a famous paradox that
      asks what would happen if a thing
      that cannot be stopped encounters
      a thing that cannot be moved.
      ',
    category: 'ET CETERA',
    pointValue: 3
  },
  {
    name: "A Pug",
    description:
      'dog breed. Generations of
      inbreeding have led to compact
      breathing passages that leave them
      unable to regulate their body
      temperature by panting. Many
      airlines have restricted their
      transport due to in-air deaths.',
    category: 'CET CETERA',
    pointValue: 2
  },
  {
    name: "Prancer",
    description:
      'One of the flying reindeer that pulls
      Santa's sleigh in “The Night Before
      Christmas." His name is also used in
      a fitness method and internet meme
      by Joanna Rohrback that is a
      "springy. rhythmic way of moving
      forward, similar to a horse’s gait and
      ideally induced by elation"',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Chairy",
    description:
      'An iconic characters from Pee—wee‘s
      Playhouse, a live—action children's
      show created by and starring Paul
      Reubens. She is a talking and
      singing piece of blue furniture with
      large eyes and a mouth between her
      cushions. She has a weirdly
      flirtatious relationship with Pee-wee.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    ...
    description:
      'A pachyderm that was smuggled
      into the US to perform in the circus.
      After killing her trainer, she was
      publicly executed by being fed
      carrots laced with cyanide and
      receiving a 6.600-volt AC current.
      The event was captured on film and
      used as a promotional stunt.',
    category: 'HISTORICAL FIGURE',
    pointValue: 4
  },
  {
    name: "David Blaine",
    description:
      'A street magician known for his
      sleight of hand, silly endurance
      
      challenges, and being kind a douche.
      
      His stunts include getting buried for
      a long time, standing on a pole for a
      long time, holding his breath for a
      long time, and freaking Ricky
      Gervais out by stabbing himself.',
    category: 'CELEBRITY',
    pointValue: 2
  },
  {
    name: "Flappy Bird",
    description:
      'The winged title character from an
      iOS game where you navigate
      through a set of pipes. The creator
      removed the game from the App
      Store, despite earning $50,000 per
      day, in the wake of criticism over
      alleged plagiarism of graphics and
      gameplay mechanics.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "The Soup Nazi",
    description:
      'A minor character from the sitcom
      Seinfeld. He exerts strict control
      over his restaurant‘s customers and
      practices price discrimination over
      the sale of his broth-based food. He
      was inspired by Al Yeganeh, a New
      York City chef, who famously took
      offense at the moniker.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "Lennie Small",
    description:
      'The large. mentally disabled friend
      of George in Of Mice and Men. He
      loves petting soft things, but is
      unable to control his strength,
      accidentally killing a puppy and a
      woman. George shoots him at the
      end of the novel to protect him
  ...
  },
  {
    name: "The Übermensch",
    description:
      'A concept created by Nietzsche in
      Thus Spoke Zarathustra that
      roughly translates to "Superman." A
      character in the book holds it up as
      a supreme goal for humanity to
      achieve. The term was incorrectly
      used by the Nazi regime to argue
      for a biologically superior race.',
    category: 'ET CETERA',
    pointValue: 3
  },
  {
    name: "Mother Teresa",
    description:
      'A missionary and Nobel Peace Prize
      winner who claimed "the world is
      being helped by the suffering of
      poor people.” Her Home for the
      Dying Destitutes in Calcutta offered
      no significant medical care and only
      7% of donations to her organization
      were directly used for charity.',
    category: 'CELEBRITY',
    pointValue: 1
  },
  {
    name: "Bill Clinton",
    description:
      'The 42nd President of the US and
      tenor saxophonist. He was the
      second president to be impeached
      in office, due to charges related to
      receiving oral sex from a White
      House intern. The case famously
      depended "on what the meaning of
      the word 'is' is."',
    category: 'HISTORICAL FIGURE',
    pointValue: 1
  },
  {
    name: "The Dude",
    description:
      'The nickname of Jeffrey Lebowski in
      the Coen Brothers film The Big
      Lebowski. Played by Jeff Bridges, he
      is depicted as an unemployed
      slacker, pacifist, and bowler who
      drinks White Russians and listens to
      Creedence. He was based on the
      Seattle Seven member Jeff Dowd.',
    category: 'FICTIONAL CHARACTER',
    pointValue: 2
  },
  {
    name: "A Rat King",
    description:
      'A creature comprised of multiple
      rodents knotted at the tail. while
      specimens exist in museums of
      curiosities, it is unlikely to ever have
      existed. It is also the name of a
      character from the Teenage Mutant
      Ninja Turtles franchise who exerts a
      telepathic influence over rodents.',
    category: 'ET CETERA',
    pointValue: 3
  }
